...
const theme = createTheme({
  palette: {
    info: {
      ...
      dark: '#1976d2', // Optional: Darker shade of the main color
    },
  },
});
...
const CustomAlert = styled(Alert)(({ theme }) => ({
  backgroundColor: theme.palette.info.dark || '#1976d2', // Fallback color if theme is not available
...
function AlertSendMessage({alert, message,close,severity}) {
