...
export const DashboardPage = () => {
    ...
    const [qrscan,setqrscan]=useState(0)
...
// For Get Toatal User
    useEffect(() => {
        const fetchUser = async () => {
          try {
            const response = await axios.get("http://localhost:4000/api/v1/user/Alluser");
    ...
    //   Get Total Send Message

      useEffect(() => {
        const fetchsend = async () => {
          try {
            const response = await axios.get("http://localhost:4000/api/v1/qr-scans/user/sentmessage");
            setsend(response.data.count);
          } catch (error) {
            console.log("Error getting user: " + error.message);
          }
        };
...
// Get all Recived Messages
      useEffect(() => {
        const fetchRecived = async () => {
          try {
            const response = await axios.get("http://localhost:4000/api/v1/qr-scans/user/recivedmessage");
            setrecived(response.data.count);
          } catch (error) {
            console.log("Error getting user: " + error.message);
          }
        };
    ...
    //   Get All Qr Scan User 
      useEffect(() => {
        const fetchQrscan = async () => {
          try {
            const response = await axios.get("http://localhost:4000/api/v1/qr-scans/user/QrDta");
            setqrscan(response.data.count);
          } catch (error) {
            console.log("Error getting user: " + error.message);
          }
        };
                        ...
                        <div className="col-lg-6 col-md-12 col-6 mb-4">
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <span className="fw-medium d-block mb-1">USER</span>
                                ...
                                <div className="card-body">
                                    <div className="card-title d-flex align-items-start justify-content-between">
                                        ...
                                        <div className="dropdown">
                                            ...
                                            >
                                                <Link aria-label="view more" className="dropdown-item" to={"/tables"}>
                                                    View More
                                                </Link>
                                    ...
                                    <span>WHASTAPP ACCOUNT</span>
                                    <h3 className="card-title text-nowrap mb-1">{qrscan}</h3>
                                ...
                                <div className="card-body">
                                    <div className="card-title d-flex align-items-start justify-content-between">
                                        ...
                                        <div className="dropdown">
                                            ...
                                            >
                                                <Link aria-label="view more" className="dropdown-item" to={"/whatsapp/sent"}>
                                                    View More
                                                </Link>
                                    ...
                                    <span className="d-block mb-1">SEND MESSAGE</span>
                                    <h3 className="card-title text-nowrap mb-2">{send}</h3>
                        ...
                        <div className="col-6 mb-4">
                            <div className="card">
                                <div className="card-body">
                                    <div className="card-title d-flex align-items-start justify-content-between">
                                        ...
                                        <div className="dropdown">
                                            ...
                                            <div className="dropdown-menu" aria-labelledby="cardOpt1">
                                                <Link aria-label="view more" className="dropdown-item" to={"/whatsapp/received"}>
                                                    View More
                                                </Link>
                                    ...
                                    <span className="fw-medium d-block mb-1">RECIVED MESSAGE</span>
                                    <h3 className="card-title mb-2">{recived}</h3>
