  ...
  return (
    <div>
        <Paper
          ...
          >
            <div id="api-whatsapp-Delete_Sent_Message">
              <Typography variant="h4" gutterBottom>
                WhatsApp- Delete WhatsAppMessage
              </Typography>
              <Typography gutterBottom>
                Delete Sent Message. Requires "delete_whatsapp_sent" API
                permission.
                <strong>delete_whatsapp_Message</strong>
              </Typography>
              <pre className="full-pre pre-get">
                <span className="typ typ-get">GET</span>{" "}
                <span className="url">
                  https://app.thewhatsappcity.com/api/delete/whatsapp.sentmessage
                </span>
              </pre>
              ...
              >
                <code>
                  {`{
    "status": 200,
    "message": "Sent WhatsApphas been deleted!",
    "data": false
  }`}
                </code>
              </pre>
