          ...
          >
            <div id="api-whatsapp_delete_sent__Chat">
              ...
              <Typography gutterBottom>
                Delete WhatsApp Account. Requires "delete_wa_account" API
                permission.
                <strong>get_delete_whatsapp_account</strong>
              </Typography>
              <pre className="full-pre pre-get">
                <span className="typ typ-get">GET</span>{" "}
                <span className="url">
                  https://app.thewhatsappcity.com/api/delete/wa.account
                </span>
              </pre>
              ...
              <Stack spacing={2} sx={{ mt: 2 }}>
                ...
                <TextField
                  label="URL"
                  value="https://app.thewhatsappcity.com/api/delete/wa.account"
...
export default DeleteWhatsappsent
